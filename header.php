                ...
                <div class="row settingsmenu">
                    <div class="sidebar shadow">
                        <div class="content">
                            ...
                            <ul class="languages">
                                <li class="top lang" key="taal">Taal:</li>
                                <li><br></li>
                                <li class="option"><button class="language dutch selected translate" id="nl"><img src="media/nl.png" alt="Nederlands"></button></li>
                                <li class="option"><button class="language english translate" id="en"><img src="media/uk.png" alt="English"></button></li>
                                <li class="option"><button class="language german translate" id="de"><img src="media/de.png" alt="Deutsch"></button></li>   
                            </ul>
                        </div>
                    </div>
                </div>
